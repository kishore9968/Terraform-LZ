subscription_id         = "7d8140b7-f7e4-43d6-b6a8-b325e124a5af"
...
vnets = {
  "corp" = {
    ...
    #   },
      {
        subnet_name                  = "snet-prod-corp-web-eus2-001"
        subnet_cidr_list             = ["10.10.206.0/24"]
        network_security_group_rules = {}
        network_security_group_name  = ""
        subnet_delegation            = []
      },
      {
        subnet_name                  = "snet-prod-corp-app-eus2-001"
        subnet_cidr_list             = ["10.10.207.0/25"]
        network_security_group_rules = {}
        network_security_group_name  = ""
        subnet_delegation            = []
      },
      {
        subnet_name                  = "snet-prod-corp-db-eus2-001"
        subnet_cidr_list             = ["10.10.207.128/25"]
        network_security_group_rules = {}
        network_security_group_name  = ""
        subnet_delegation            = []
      },
